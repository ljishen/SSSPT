These profiles are different from folder 4 that the CPUs of the system testbed are set to use the `performance` scaling governor. The system information is the same:
